...
class WalletPhoneNumber extends \App\Shared\Domain\ValueObject\ValueObject
{
    private function __construct(private mixed $phoneNumber)
    {
    }

    public static function create(mixed $phoneNumber): self
    {
